...
-- crm_whatsapp_bot_logs: registro operacional de tudo que acontece com o bot
...
-- crm_faturamentos: faturamento (retorno real) da oportunidade
...
-- crm_pedidos_venda: pedidos de venda (vendas geradas) da oportunidade
...
-- Engenharia de Processos: ontologia (Empresa → Site → Área → Processo → Subprocesso → Atividade)
...
-- Reuniões: repositório/histórico de reuniões (pauta, ata, participantes, encaminhamentos, links)
