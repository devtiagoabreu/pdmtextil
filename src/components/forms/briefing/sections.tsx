...
export function SecaoAplicacao({
  ...
  control: Control<BriefingTecelagem>
  errors: FieldErrors<BriefingTecelagem>
}) {
  return (
    <section className="space-y-4">
...
export function SecaoRequisitosTecnicos({
  control,
  errors,
}: {
  control: Control<BriefingTecelagem>
            ...
            render={({ field }) => (
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="tecido_plano" className="cursor-pointer">
                    Tecido Plano
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="JACQUARD" id="tecido_jacquard" />
                  <Label htmlFor="tecido_jacquard" className="cursor-pointer">
                    Jacquard
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="MALHA" id="tecido_malha" />
                  <Label htmlFor="tecido_malha" className="cursor-pointer">
                    Malha
                  </Label>
                </div>
              </RadioGroup>
...
export function SecaoPerformance({
  control,
  errors,
}: {
  control: Control<BriefingTecelagem>
            ...
            render={({ field }) => (
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="abr_baixa" className="cursor-pointer">
                    Baixa (escritório, uso leve)
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="MEDIA" id="abr_media" />
                  <Label htmlFor="abr_media" className="cursor-pointer">
                    Média (logística, uso moderado)
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="ALTA" id="abr_alta" />
                  <Label htmlFor="abr_alta" className="cursor-pointer">
                    Alta (indústria, uso intenso)
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="MUITO_ALTA" id="abr_muito_alta" />
                  <Label htmlFor="abr_muito_alta" className="cursor-pointer">
                    Muito Alta (uso extremo)
                  </Label>
                </div>
              </RadioGroup>
            )}
        ...
        <div className="space-y-3">
          ...
          <div className="space-y-2">
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="res_lav" className="cursor-pointer">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="res_sec" className="cursor-pointer">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="res_pass" className="cursor-pointer">
...
export function SecaoAcabamento({
  control,
  errors,
}: {
  control: Control<BriefingTecelagem>
            ...
            render={({ field }) => (
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="brilho_fosco" className="cursor-pointer">
                    Fosco
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="SEMI_FOSCO" id="brilho_semi" />
                  <Label htmlFor="brilho_semi" className="cursor-pointer">
                    Semi-Fosco
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="BRILHANTE" id="brilho_brilhante" />
                  <Label htmlFor="brilho_brilhante" className="cursor-pointer">
                    Brilhante
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="ALTO_BRILHO" id="brilho_alto" />
                  <Label htmlFor="brilho_alto" className="cursor-pointer">
                    Alto Brilho
                  </Label>
                </div>
              </RadioGroup>
            ...
            render={({ field }) => (
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="toque_seco" className="cursor-pointer">
                    Seco / Técnico
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="MACIO" id="toque_macio" />
                  <Label htmlFor="toque_macio" className="cursor-pointer">
                    Macio
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="SUAVE" id="toque_suave" />
                  <Label htmlFor="toque_suave" className="cursor-pointer">
                    Suave
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="ESTRUTURADO" id="toque_estruturado" />
                  <Label htmlFor="toque_estruturado" className="cursor-pointer">
                    Estruturado
                  </Label>
                </div>
              </RadioGroup>
            ...
            render={({ field }) => (
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="cor_solidas" className="cursor-pointer">
                    Cores Sólidas (Padrão)
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="ESTAMPADAS" id="cor_estampadas" />
                  <Label htmlFor="cor_estampadas" className="cursor-pointer">
                    Estampadas
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="FANTASIA" id="cor_fantasia" />
                  <Label htmlFor="cor_fantasia" className="cursor-pointer">
                    Fantasia
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="DESENVOLVIMENTO_EXCLUSIVO" id="cor_exclusivo" />
                  <Label htmlFor="cor_exclusivo" className="cursor-pointer">
...
export function SecaoComercial({
  control,
  errors,
}: {
  control: Control<BriefingTecelagem>
            ...
            render={({ field }) => (
              ...
              >
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="preco_economico" className="cursor-pointer">
                    Econômico
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="INTERMEDIARIO" id="preco_intermediario" />
                  <Label htmlFor="preco_intermediario" className="cursor-pointer">
                    Intermediário
                  </Label>
                </div>
                <div className="flex items-center space-x-2">
                  <RadioGroupItem value="PREMIUM" id="preco_premium" />
                  <Label htmlFor="preco_premium" className="cursor-pointer">
                    Premium
                  </Label>
                </div>
              </RadioGroup>
