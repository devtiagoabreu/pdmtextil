...
export function RichTextEditor({
  ...
  return (
    <div className="w-full border rounded-lg border-slate-300 dark:border-slate-600 overflow-hidden bg-white dark:bg-slate-700">
      <div
        className="flex flex-wrap items-center gap-1 p-2 bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700"
      ...
      >
        <div className="flex items-center gap-1 px-1 border-r border-slate-200 dark:border-slate-700">
          <button
            type="button"
            onClick={() => exec("bold")}
            className="p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-700 min-h-[36px] min-w-[36px] flex items-center justify-center"
            title="Negrito"
          >
            <Bold size={16} />
          </button>
        ...
        <div className="flex items-center gap-1 px-1 border-r border-slate-200 dark:border-slate-700">
          <select
            ...
            className="text-xs p-1.5 rounded border bg-white dark:bg-slate-700 border-slate-300 dark:border-slate-600 w-20 sm:w-28 min-h-[36px]"
            title="Fonte"
          >
          ...
          <select
            ...
            className="text-xs p-1.5 rounded border bg-white dark:bg-slate-700 border-slate-300 dark:border-slate-600 w-16 sm:w-20 min-h-[36px]"
            title="Tamanho"
          >
        ...
        <div className="flex items-center gap-1 px-1 border-r border-slate-200 dark:border-slate-700">
          ...
          <button
            ...
            className="p-2 rounded hover:bg-slate-200 dark:hover:bg-slate-700 min-h-[36px] min-w-[36px] flex items-center justify-center relative"
            title="Cor de Fundo"
          >
