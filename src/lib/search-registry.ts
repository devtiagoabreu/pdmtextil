...
export const searchRegistry: SearchItem[] = [
  ...
  { id: "ativos-categorias", label: "Categorias de Ativos", keywords: ["categoria", "categorias", "setor", "area", "ativo"], href: "/ativos/categorias", description: "Categorias de ativos por área", module: "Ativos" },
  { id: "ativos-categorias-novo", label: "Nova Categoria", keywords: ["categoria", "nova", "criar", "setor", "area"], href: "/ativos/categorias/novo", description: "Cadastrar nova categoria de ativo", module: "Ativos" },
