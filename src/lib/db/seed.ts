...
async function seed() {
  ...
  await db.insert(userMenuItens).values([
    ...
    { userMenuId: menuCrm.id, titulo: "Propostas", url: "/comercial/crm/propostas", ordem: 10 },
  ...
  await db.insert(userMenuItens).values([
    ...
    { userMenuId: menuCrmRole.id, titulo: "Propostas", url: "/comercial/crm/propostas", ordem: 10 },
