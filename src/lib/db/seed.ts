...
async function seed() {
  ...
  await db.insert(userMenuItens).values([
    ...
    { userMenuId: menuCrm.id, titulo: "Tarefas", url: "/comercial/crm/tarefas", ordem: 8 },
    { userMenuId: menuCrm.id, titulo: "Propostas", url: "/comercial/crm/propostas", ordem: 9 },
    { userMenuId: menuCrm.id, titulo: "Regiões", url: "/comercial/crm/regioes", ordem: 10 },
    { userMenuId: menuCrm.id, titulo: "Equipes", url: "/comercial/crm/equipes", ordem: 11 },
    { userMenuId: menuCrm.id, titulo: "Campanhas", url: "/comercial/crm/campanhas", ordem: 12 },
    { userMenuId: menuCrm.id, titulo: "Conversas WhatsApp", url: "/comercial/crm/conversas", ordem: 13 },
    { userMenuId: menuCrm.id, titulo: "Notificações", url: "/comercial/crm/notificacoes", ordem: 14 },
    { userMenuId: menuCrm.id, titulo: "Relatórios", url: "/comercial/crm/relatorios", ordem: 15 },
  ])
  ...
  await db.insert(userMenuItens).values([
    ...
    { userMenuId: menuCrmRole.id, titulo: "Tarefas", url: "/comercial/crm/tarefas", ordem: 8 },
    { userMenuId: menuCrmRole.id, titulo: "Propostas", url: "/comercial/crm/propostas", ordem: 9 },
    { userMenuId: menuCrmRole.id, titulo: "Regiões", url: "/comercial/crm/regioes", ordem: 10 },
    { userMenuId: menuCrmRole.id, titulo: "Equipes", url: "/comercial/crm/equipes", ordem: 11 },
    { userMenuId: menuCrmRole.id, titulo: "Campanhas", url: "/comercial/crm/campanhas", ordem: 12 },
    { userMenuId: menuCrmRole.id, titulo: "Conversas WhatsApp", url: "/comercial/crm/conversas", ordem: 13 },
    { userMenuId: menuCrmRole.id, titulo: "Notificações", url: "/comercial/crm/notificacoes", ordem: 14 },
    { userMenuId: menuCrmRole.id, titulo: "Relatórios", url: "/comercial/crm/relatorios", ordem: 15 },
  ])
  ...
  await db.insert(userMenuItens).values([
    ...
    { userMenuId: menuCrmAdmin.id, titulo: "Tarefas", url: "/comercial/crm/tarefas", ordem: 8 },
    { userMenuId: menuCrmAdmin.id, titulo: "Propostas", url: "/comercial/crm/propostas", ordem: 9 },
    { userMenuId: menuCrmAdmin.id, titulo: "Regiões", url: "/comercial/crm/regioes", ordem: 10 },
    { userMenuId: menuCrmAdmin.id, titulo: "Equipes", url: "/comercial/crm/equipes", ordem: 11 },
    { userMenuId: menuCrmAdmin.id, titulo: "Campanhas", url: "/comercial/crm/campanhas", ordem: 12 },
    { userMenuId: menuCrmAdmin.id, titulo: "Conversas WhatsApp", url: "/comercial/crm/conversas", ordem: 13 },
    { userMenuId: menuCrmAdmin.id, titulo: "Notificações", url: "/comercial/crm/notificacoes", ordem: 14 },
    { userMenuId: menuCrmAdmin.id, titulo: "Relatórios", url: "/comercial/crm/relatorios", ordem: 15 },
  ])
