...
export const reunioesProjetos = pgTable(
  "reunioes_projetos",
  {
  ...
  (t: any) => [index("idx_reunioes_projetos_status").on(t.status)]
)
...
export const reunioes = pgTable(
  "reunioes",
  {
    ...
    projetoId: integer("projeto_id")
      .notNull()
      .default(1)
      .references(() => reunioesProjetos.id),
...
export const reuniaoPautas = pgTable(
  "reuniao_pautas",
  {
    id: serial("id").primaryKey(),
    reuniaoId: integer("reuniao_id")
  ...
  (t: any) => [index("idx_reuniao_pautas_reuniao_id").on(t.reuniaoId)]
)

export const reuniaoParticipantes = pgTable(
  ...
  (t: any) => [index("idx_reuniao_participantes_reuniao_id").on(t.reuniaoId)]
)

export const reuniaoEncaminhamentos = pgTable(
  ...
  (t: any) => [index("idx_reuniao_encaminhamentos_reuniao_id").on(t.reuniaoId)]
)

export const reuniaoLinks = pgTable(
  "reuniao_links",
  {
    id: serial("id").primaryKey(),
    reuniaoId: integer("reuniao_id")
  ...
  (t: any) => [index("idx_reuniao_links_reuniao_id").on(t.reuniaoId)]
)
