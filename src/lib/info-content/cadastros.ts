...
export const cadastrosContent: Record<string, InfoContent> = {
  "/cadastros": {
    title: "Cadastros",
    description:
      "Módulo central de cadastros técnicos do sistema. Aqui você gerencia produtos, insumos, fornecedores e dados de produção.",
    rules: [
  ...
  "/cadastros/produto-cru": {
    title: "Produtos",
    description:
      "Gerencie os produtos (tecidos e malhas) que servem como base para a produção. Cada produto possui composição, estrutura e receitas associadas.",
    rules: [
  ...
  "/cadastros/fios": {
    title: "Fios",
    description:
      "Cadastro de fios utilizados na composição dos produtos cru. Inclui informações como título, matéria-prima e fornecedores.",
    rules: [
  ...
  "/cadastros/fornecedores": {
    title: "Fornecedores",
    description:
      "Cadastro de fornecedores de insumos, fios, produtos químicos e serviços terceirizados.",
    rules: [
  ...
  "/cadastros/bases-urdume": {
    title: "Bases Urdume",
    description:
      "Gerencie as bases de urdume utilizadas na tecelagem. Cada base define fios e comprimentos para preparação do tear.",
    rules: [
  ...
  "/cadastros/cores": {
    title: "Cores",
    description:
      "Catálogo de cores utilizadas nos produtos. Cada cor possui um código interno e referência do cliente.",
    rules: [
  ...
  "/cadastros/produtos-quimicos": {
    ...
    description:
      "Cadastro de produtos químicos utilizados nas receitas de beneficiamento e acabamento.",
    rules: [
  ...
  "/cadastros/receitas": {
    title: "Receitas",
    description:
      "Cadastro de receitas técnicas de beneficiamento e acabamento para produtos têxteis.",
    rules: [
