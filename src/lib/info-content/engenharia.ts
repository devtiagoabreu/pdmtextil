...
export const campoAtivo: InfoContent = campo(
  ...
  [
    {
      title: "Usar inativo",
      desc: "Para um site que não recebe processos novos, desmarque Ativo e ele deixa de aparecer nas listas de seleção.",
    },
  ]
)
...
export const campoOrdem: InfoContent = campo(
  ...
  [
    {
      title: "Exemplo",
      desc: "Ordem 1 → Preparação dos fios; Ordem 2 → Tingimento; Ordem 3 → Acabamento.",
    },
  ]
)
...
export const campoObservacoes: InfoContent = campo(
  ...
  [
    {
      title: "Exemplo",
      desc: "Processo depende da liberação do setor de qualidade antes do envio ao cliente.",
    },
  ]
)
  ...
  [
    {
      ...
      desc: "URL da instrução oficial do processo em PDF ou no sistema.",
    },
    { title: "Vídeo de treinamento", desc: "URL do vídeo que mostra a execução da atividade." },
    {
      title: "Planilha de controle",
      desc: "URL do arquivo usado para registrar o acompanhamento.",
    },
  ]
)
...
export const empresaCampos: Record<string, InfoContent> = {
  nome: campo(
    ...
    [
      ...
      {
        title: "Fiação Santa Cláudia",
        desc: "Exemplo de fornecedora de fios cadastrada para o mapeamento.",
      },
    ]
  ),
  cnpj: campo(
  ...
  segmento: campo(
    ...
    [
      {
        title: "Têxtil",
        desc: "Fiação, tecelagem, malharia, beneficiamento e confecção são segmentos do setor têxtil.",
      },
...
export const siteCampos: Record<string, InfoContent> = {
  empresaId: campo("Empresa", "Organização à qual a unidade física pertence.", [
  ...
  cep: campo("CEP", "Código de Endereçamento Postal da unidade. Preenchimento opcional.", [
    { title: "89000-000", desc: "Formato com traço." },
  ]),
  endereco: campo("Endereço", "Endereço completo da unidade: rua, número e bairro.", [
    {
      title: "Rua Itajaí, 1500, Centro",
      desc: "Ajuda a localizar a unidade em mapas e na logística.",
    },
  ]),
  cidade: campo("Cidade", "Município em que a unidade está localizada.", [
    { title: "Blumenau", desc: "Exemplo de cidade com forte polo têxtil." },
  ]),
  uf: campo("UF", "Unidade da Federação (sigla do estado) da unidade.", [
...
export const areaCampos: Record<string, InfoContent> = {
  siteId: campo("Site", "Unidade física à qual o setor ou departamento pertence.", [
    {
      title: "Unidade PDM Têxtil",
      desc: "A área de Tecelagem normalmente pertence à unidade principal.",
    },
  ]),
  nome: campo("Nome", "Nome do setor ou departamento onde os processos são executados.", [
...
export const subprocessoCampos: Record<string, InfoContent> = {
  processoId: campo("Processo", "Processo ao qual esta etapa pertence.", [
    ...
    [
      {
        ...
        desc: "Ex.: urdimento, engomagem e passação de fios antes do tingimento.",
      },
    ]
  ),
  ordem: campoOrdem,
...
export const atividadeCampos: Record<string, InfoContent> = {
  subprocessoId: campo("Subprocesso", "Subprocesso ao qual a atividade pertence.", [
    {
      title: "Preparação dos fios",
      desc: "Selecione o subprocesso antes de cadastrar a atividade.",
    },
  ]),
  nome: campo(
    "Nome",
    ...
    [
      { title: "Encarar materiais", desc: "Ex.: colocar os rolos de fio na máquina." },
      {
        ...
        desc: "Ex.: conferir a nota fiscal no recebimento de matéria-prima.",
      },
  ...
  tipo: campo(
    ...
    [
      ...
      {
        title: "Decisão",
        desc: "O tecido passou na inspeção? Se sim, segue; se não, volta para o setor.",
      },
      { title: "Espera", desc: "Aguardar a matéria-prima chegar ao setor." },
    ]
  ),
  responsavel: campo("Responsável", "Pessoa, cargo, equipe ou máquina que executa a atividade.", [
    { title: "Operador de tecelagem", desc: "Quem opera a máquina." },
    { title: "Conferente", desc: "Quem confere a nota no recebimento." },
    {
      title: "PCP",
      desc: "Planejamento e Controle da Produção, responsável pelas ordens de produção.",
    },
  ]),
  ordem: campoOrdem,
  links: campoLinks,
...
export const processoCampos: Record<string, InfoContent> = {
  areaId: campo("Área", "Setor ou departamento onde o processo acontece.", [
    ...
    [
      {
        ...
        desc: "Documenta o recebimento e a conferência de fios e insumos.",
      },
  ...
  status: campo(
    ...
    [
      ...
      {
        title: "Em revisão",
        desc: "O processo foi finalizado e está sendo revisado pelo responsável.",
      },
  ...
  responsavel: campo(
    ...
    [
      {
        title: "Coordenador de Tecelagem",
        desc: "Exemplo de responsável pelo processo de Tecelagem.",
      },
    ]
  ),
  objetivo: campo(
    ...
    [
      {
        title: "Produzir tecidos premium",
        desc: "O objetivo deixa claro o resultado esperado do processo.",
      },
    ]
  ),
  entradas: campo(
  ...
  indicadores: campo(
    ...
    [
      { title: "OEE (Eficiência Global)", desc: "Ex.: unidade %, meta 85%, medido mensalmente." },
      {
        ...
        desc: "Ex.: unidade %, meta inferior a 3%, medido semanalmente.",
      },
  ...
  riscos: campo(
    ...
    [
      {
        title: "Produto divergente do pedido",
        desc: "Probabilidade média, impacto alto. Controle: conferência no recebimento.",
      },
      {
        title: "Atraso do fornecedor",
        desc: "Probabilidade alta, impacto médio. Controle: pedido feito com antecedência.",
      },
      {
        title: "Quebra de máquina",
        desc: "Probabilidade baixa, impacto alto. Controle: manutenção preventiva.",
      },
    ]
  ),
  controles: campo(
    ...
    [
      {
        title: "Conferência de peso e rolos",
        desc: "Responsável: conferente. Frequência: a cada recebimento.",
      },
      {
        title: "Conferência da nota fiscal vs. ordem de compra",
        desc: "Responsável: comprador. Frequência: a cada compra.",
      },
      {
        title: "Manutenção preventiva das máquinas",
        desc: "Responsável: manutenção. Frequência: mensal.",
      },
    ]
  ),
  links: campoLinks,
