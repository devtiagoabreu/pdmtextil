  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-50">
            Treinamento Engenharia de Processos{info && <InfoButton content={info} />}
          </h1>
        </div>
        <div className="flex items-center gap-3">
          <Link
            href="/processos/treinamento/exportar-pdf"
            className="inline-flex items-center gap-1.5 text-sm text-sky-600 hover:text-sky-800 dark:text-sky-400 dark:hover:text-sky-300 transition-colors"
          >
            <Printer size={16} />
      ...
      <p className="text-slate-600 dark:text-slate-400 mb-8 max-w-3xl">
        Documentação completa da Engenharia de Processos com explicações campo a campo,
        pré-cadastros necessários, links para POPs e vídeos tutoriais. Use este guia para aprender
        como cada tela funciona e por que cada campo é importante.
      </p>
                      ...
                      <div className="divide-y divide-slate-100 dark:divide-slate-800">
                        {modulo.licoes
                          ...
                          .map((licao) => (
                            <Link
                              key={licao.id}
                              href={`/processos/treinamento/${licao.id}`}
                            ...
                            >
                              ...
                              <span className="text-sm text-slate-700 dark:text-slate-300 group-hover:text-sky-600 dark:group-hover:text-sky-400 transition-colors">
                                {licao.titulo}
                              </span>
