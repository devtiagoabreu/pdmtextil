...
import { exportLicaoPdf } from "@/lib/export-treinamento-processos-pdf"
      ...
      <div className="p-6 max-w-4xl mx-auto">
        <div className="flex items-start justify-between gap-4 mb-8">
          <div className="flex items-center gap-3">
            <div
              ...
              style={{ backgroundColor: licao.moduloCor || "#0ea5e9" }}
            >
          ...
          <button
            ...
            disabled={exportando}
            className="no-print inline-flex items-center gap-1.5 px-3 py-1.5 text-sm text-white bg-sky-600 border border-sky-600 rounded-lg hover:bg-sky-700 disabled:opacity-50 transition-colors"
          >
        ...
        <div className="no-print flex items-center justify-between pt-6 border-t border-slate-200 dark:border-slate-700">
          <div>
            {licaoAnterior && (
              <Link
                href={`/processos/treinamento/${licaoAnterior.id}`}
                className="inline-flex items-center gap-1.5 text-sm text-slate-600 dark:text-slate-400 hover:text-sky-600 transition-colors"
              >
                <ChevronLeft size={16} />
          ...
          <div>
            {proximaLicao && (
              <Link
                href={`/processos/treinamento/${proximaLicao.id}`}
                className="inline-flex items-center gap-1.5 text-sm text-slate-600 dark:text-slate-400 hover:text-sky-600 transition-colors"
              >
                {proximaLicao.titulo}
