        ...
        <div className="no-print flex items-center gap-4 mb-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-sm text-slate-500 mt-1">
              Esta página contém todos os módulos e lições do treinamento CRM. Clique em {"\u201C"}
          ...
          <div className="pdf-content">
            ...
            <div className="text-center py-16 mb-8 border-b border-slate-200">
              ...
              <div className="mt-8 text-xs text-slate-400 max-w-md mx-auto leading-relaxed">
                <p>
                  CRM construído com carinho por{" "}
                  <strong>Tiago de Abreu — Engenheiro de Dados</strong>
                </p>
                <p className="mt-2">
                  {"\u201C"}CRM não é sobre tecnologia, é sobre pessoas. Pessoas atendendo melhor
                  outras pessoas.{"\u201D"}
                </p>
              </div>
            </div>
