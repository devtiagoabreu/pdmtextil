  ...
  return (
    <div className="p-6 max-w-5xl mx-auto">
      ...
      <p className="text-slate-600 dark:text-slate-400 mb-8 max-w-3xl">
        Documentação completa do CRM com explicações campo a campo, pré-cadastros necessários, links
        para POPs e vídeos tutoriais. Use este guia para aprender como cada tela funciona e por que
        cada campo é importante.
      </p>
