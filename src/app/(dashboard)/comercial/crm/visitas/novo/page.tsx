    ...
    try {
      const res = await fetch("/api/crm/visitas", {
        ...
        body: JSON.stringify({
          ...
          representanteId: form.representanteId ? parseInt(form.representanteId) : null,
          representanteNome: form.representanteNome || null,
          propostaId: form.propostaId ? parseInt(form.propostaId) : null,
