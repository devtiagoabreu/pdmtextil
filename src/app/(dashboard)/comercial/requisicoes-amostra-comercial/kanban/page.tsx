...
import { KanbanAmostraComercial } from "./kanban-board"

const CHANNEL = "kanban-amostra-comercial-sync"

export default function KanbanAmostraComercialPage() {
  ...
  const handleDetach = () => {
    window.open("/kanban-standalone", "kanban", "width=1400,height=900")
    setIsDetached(true)
  }
      ...
      <div className="flex items-center justify-between shrink-0 px-6 pt-6 pb-2">
        <div className="flex items-center gap-2">
          <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-50">
            Kanban â€” Amostras Comerciais{info && <InfoButton content={info} />}
          </h1>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            title={isDetached ? "Recolocar kanban na aplicaÃ§Ã£o" : "Descolar kanban em janela flutuante"}
          >
      ...
      {isDetached ? (
        <div className="flex-1 flex items-center justify-center text-slate-500">
          <div className="text-center space-y-3">
            ...
            <p className="text-sm text-slate-400">VocÃª pode arrastÃ¡-lo para outra tela ou monitor</p>
            <button
