...
describe("FerramentasHubPage", () => {
  it("renderiza o heading e os cards de ferramentas", () => {
    ...
    expect(screen.getByRole("link", { name: /Consulta CNPJ/ })).toHaveAttribute(
      "href",
      "/ferramentas/consulta-cnpj"
    )
    expect(screen.getByRole("link", { name: /Calculadora de Regra de Três/ })).toHaveAttribute(
      "href",
      "/ferramentas/regra-de-tres"
    )
    expect(screen.getByRole("link", { name: /Numeração de Fio/ })).toHaveAttribute(
      "href",
