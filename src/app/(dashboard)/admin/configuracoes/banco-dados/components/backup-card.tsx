  ...
  return (
    <div className="rounded-xl border border-slate-200 dark:border-slate-800 p-6 bg-white dark:bg-slate-900 space-y-4">
      ...
      <p className="text-sm text-slate-500">
        Gera um dump SQL completo (estrutura + dados) de todas as tabelas e faz o download para o
        computador. Usa a conexão ativa cadastrada, ou a variável DATABASE_URL como fallback.
      </p>
      <div className="flex flex-wrap gap-2">
        ...
        {temAtivo && <p className="text-xs text-slate-400 self-center">Usando conexão ativa</p>}
      </div>
    </div>
  )
}
