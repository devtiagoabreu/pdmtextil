        ...
        <div>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-2xl font-bold text-slate-900 dark:text-slate-50">
              Empresas{info && <InfoButton content={info} />}
            </h1>
          </div>
          <p className="text-sm text-slate-500 mt-1">
            Configure as empresas do sistema (logo, dados) para relatórios e exportações
          </p>
        </div>
      </div>
                ...
                <div className="flex items-start gap-4 min-w-0 flex-1">
                  ...
                  <div className="min-w-0 flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {item.isDefault && (
                        <span className="text-[11px] px-1.5 py-0.5 rounded bg-green-100 text-green-700 font-medium">
                          Padrão
                        </span>
                      )}
                    </div>
      ...
      {showForm && (
        <div className="rounded-xl border border-slate-200 dark:border-slate-800 p-6 space-y-4 bg-white dark:bg-slate-900">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              <Label>UF</Label>
              <SelectUf value={uf} onChange={setUf} className="w-full" />
            </div>
            <div className="space-y-2">
              <Label>Cidade</Label>
              <SelectCidade
