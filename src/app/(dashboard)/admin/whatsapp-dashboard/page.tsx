        ...
        <>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
            <StatCard
              ...
              value={data.resumo.totalConversas}
              color="bg-blue-600"
            />
            <StatCard
              icon={Users}
              label="Leads Criados"
              value={data.resumo.totalLeads}
            ...
            <StatCard
              icon={Clock}
              label="Tempo Medio"
              value={`${data.resumo.tempoMedioMinutos}m`}
              color="bg-amber-600"
            />
            <StatCard
              icon={Zap}
              label="Ativos 24h"
              value={data.resumo.ativas24h}
              color="bg-purple-600"
            />
          </div>
                ...
                <div className="space-y-3">
                  {data.porEstado.map((e: any) => (
                    <div key={e.estado} className="flex items-center gap-3">
                      <span
                        className="text-xs font-medium text-slate-600 dark:text-slate-300 w-32 truncate"
                        title={e.estado}
                      >
            ...
            <Card>
              <CardContent className="p-4">
                ...
                <p className="text-xs text-slate-400 mt-3">
                  Clientes que pararam em cada etapa (fora de Saudacao e Encerrado)
                </p>
              </CardContent>
            </Card>
          </div>
