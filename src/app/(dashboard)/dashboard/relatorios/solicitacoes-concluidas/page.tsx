...
const SolicitacoesConcluidasCharts = dynamic(() => import("./charts").then((m) => m.SolicitacoesConcluidasCharts), { ssr: false })
...
export default function RelatorioSolicitacoesConcluidas() {
  ...
  function handleExportCSV() {
    setTimeout(() => {
      exportCSV("concluidas-desenvolvimento", ["#", "Cliente", "Projeto", "Tipo", "Criado em", "Concluído em", "Dias em Dev"], lista.map((r: any) => [
        r.id,
        r.cliente,
        r.projeto || "-",
  ...
  async function handleExportPDF() {
    await exportPDFRelatorio({
      ...
      tables: [
        ...
        { headers: ["#", "Cliente", "Projeto", "Tipo", "Criado em", "Concluído em", "Dias"], rows: lista.map((r: any) => [
          r.id,
          r.cliente,
          r.projeto || "-",
          r.tipo === "DESENVOLVIMENTO_TECELAGEM" ? "Tecelagem" : "Beneficiamento",
