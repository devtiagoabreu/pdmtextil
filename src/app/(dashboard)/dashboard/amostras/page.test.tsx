...
describe("DashboardAmostras", () => {
  it("renderiza o heading e o estado vazio de amostras recentes", async () => {
    ...
    expect(
      screen.getByRole("heading", { name: /Dashboard de Amostras de Desenvolvimento/ })
    ).toBeInTheDocument()
  ...
  it("abre o modal de filtro como dialog acessível ao clicar num card", async () => {
    ...
    await waitFor(() =>
      expect(screen.queryByRole("dialog", { name: "Total Mês" })).not.toBeInTheDocument()
    )
  })
})
