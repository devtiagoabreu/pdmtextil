...
export async function GET(req: NextRequest) {
  try {
    ...
    const campos = [
      ...
      { nome: "densidade", descricao: "Densidade em fios/cm (opcional)", exemplo: "30" },
      { nome: "tratamentoEncolagem", descricao: "Tratamento de encolagem (opcional)", exemplo: "Mercerização" },
        ...
        exemplo: [
          {
            ...
            densidade: "30",
            tratamentoEncolagem: "Mercerização",
            tensaoUrdume: "25",
            largura: "2.50",
            observacoes: "",
            idIntegracao: "SYS001",
