...
export async function PUT(
  ...
  try {
    ...
    const [atualizado] = await db
      ...
      .where(eq(procTreinoModulos.id, idNum))
      .returning()
    ...
    console.error("[PUT /api/processos/treinamento/modulos]", error)
...
export async function DELETE(
  ...
  try {
    ...
    console.error("[DELETE /api/processos/treinamento/modulos]", error)
    return NextResponse.json({ error: "Erro interno do servidor" }, { status: 500 })
  }
}