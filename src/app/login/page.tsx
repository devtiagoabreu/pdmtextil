...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    if (err === "EmailNaoCadastrado")
      setError("Este email não possui cadastro no sistema. Solicite a um administrador.")
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      const data = await fetch("/api/user/pagina-inicial").then((r: any) =>
        r.ok ? r.json() : null
      )
